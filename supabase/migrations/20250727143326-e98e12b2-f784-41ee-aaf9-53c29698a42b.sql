...
-- Fix api_configurations policies
...
-- Fix review_category_settings policies
...
-- Fix cargas policies - remove public access
...
-- Fix 6: Create rate limiting table and function
